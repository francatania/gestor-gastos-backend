...
app.use(cors({origin: ['https://mi-gestor-gastos.netlify.app', 'http://localhost:5173', 'https://server-reset.netlify.app'], methods:['GET', 'PUT', 'POST', 'DELETE'], credentials: true }));
